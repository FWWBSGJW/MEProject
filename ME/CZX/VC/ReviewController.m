...
{
    SubjectController *vc = [[SubjectController alloc] initWithCorrectAnswer:myCorrectArray personAnswer:myPersonArray questionArray:myQuestionArray answerArray:myAnswerArray page:btn.tag-100];
//    vc.myTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 44, 320, 440)];
